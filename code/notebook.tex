...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{input\PYZus{}layer}\PY{p}{,} \PY{n}{filters}\PY{p}{,} \PY{n}{strides}\PY{p}{)}\PY{p}{:}
            ...
            \PY{c+c1}{\PYZsh{} Create a separable convolution layer using the separable\PYZus{}conv2d\PYZus{}batchnorm() function.}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{k}{def} \PY{n+nf}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{small\PYZus{}ip\PYZus{}layer}\PY{p}{,} \PY{n}{large\PYZus{}ip\PYZus{}layer}\PY{p}{,} \PY{n}{filters}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{concatenate} \PY{o}{=} \PY{n}{layers}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{[}\PY{n}{upsample}\PY{p}{,} \PY{n}{large\PYZus{}ip\PYZus{}layer}\PY{p}{]}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} Add some number of separable convolution layers}
            \PY{n}{sep\PYZus{}conv} \PY{o}{=} \PY{n}{separable\PYZus{}conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{concatenate}\PY{p}{,} \PY{n}{filters}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
            \PY{n}{output\PYZus{}layer} \PY{o}{=} \PY{n}{separable\PYZus{}conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{sep\PYZus{}conv}\PY{p}{,} \PY{n}{filters}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{fcn\PYZus{}model}\PY{p}{(}\PY{n}{inputs}\PY{p}{,} \PY{n}{num\PYZus{}classes}\PY{p}{)}\PY{p}{:}
            ...
            \PY{n}{layer\PYZus{}1} \PY{o}{=} \PY{n}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{inputs}\PY{p}{,} \PY{l+m+mi}{64}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
            \PY{n}{layer\PYZus{}2} \PY{o}{=} \PY{n}{encoder\PYZus{}block}\PY{p}{(}\PY{n}{layer\PYZus{}1}\PY{p}{,} \PY{l+m+mi}{128}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} Add 1x1 Convolution layer using conv2d\PYZus{}batchnorm().}
            \PY{n}{layer\PYZus{}3} \PY{o}{=} \PY{n}{conv2d\PYZus{}batchnorm}\PY{p}{(}\PY{n}{layer\PYZus{}2}\PY{p}{,} \PY{l+m+mi}{256}\PY{p}{,} \PY{n}{kernel\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} Add the same number of Decoder Blocks as the number of Encoder Blocks}
            \PY{n}{layer\PYZus{}4} \PY{o}{=} \PY{n}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{layer\PYZus{}3}\PY{p}{,} \PY{n}{layer\PYZus{}1}\PY{p}{,} \PY{l+m+mi}{128}\PY{p}{)}
            \PY{n}{layer\PYZus{}5} \PY{o}{=} \PY{n}{decoder\PYZus{}block}\PY{p}{(}\PY{n}{layer\PYZus{}4}\PY{p}{,} \PY{n}{inputs}\PY{p}{,} \PY{l+m+mi}{64}\PY{p}{)}
            ...
            \PY{k}{return} \PY{n}{layers}\PY{o}{.}\PY{n}{Conv2D}\PY{p}{(}\PY{n}{num\PYZus{}classes}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{,} \PY{n}{activation}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{softmax}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{same}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{(}\PY{n}{layer\PYZus{}5}\PY{p}{)}
\end{Verbatim}
...
work with.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{}LearningRate = InitialLearningRate * DropRate\PYZca{}floor(Epoch / EpochDrop)}
         ...
         \PY{n}{steps\PYZus{}per\PYZus{}epoch} \PY{o}{=} \PY{l+m+mi}{64}
         \PY{n}{validation\PYZus{}steps} \PY{o}{=} \PY{l+m+mi}{50}
         \PY{n}{workers} \PY{o}{=} \PY{l+m+mi}{70}
\end{Verbatim}
...
Epoch 15/40
 2/64 [{\ldots}] - ETA: 114s - loss: 0.0220
    ...
    --> 789                          run\_metadata\_ptr)
        ...
        /home/ubuntu/anaconda3/lib/python3.6/site-packages/tensorflow/python/client/session.py in \_run(self, handle, fetches, feed\_dict, options, run\_metadata)
    ...
    --> 997                              feed\_dict\_string, options, run\_metadata)
        ...
        /home/ubuntu/anaconda3/lib/python3.6/site-packages/tensorflow/python/client/session.py in \_do\_run(self, handle, target\_list, fetch\_list, feed\_dict, options, run\_metadata)
    ...
    -> 1132                            target\_list, options, run\_metadata)
       ...
       1134       return self.\_do\_call(\_prun\_fn, self.\_session, handle, feed\_dict,
        ...
        /home/ubuntu/anaconda3/lib/python3.6/site-packages/tensorflow/python/client/session.py in \_do\_call(self, fn, *args)
    ...
    -> 1139       return fn(*args)
       ...
       1141       message = compat.as\_text(e.message)
        ...
        /home/ubuntu/anaconda3/lib/python3.6/site-packages/tensorflow/python/client/session.py in \_run\_fn(session, feed\_dict, fetch\_list, target\_list, options, run\_metadata)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{} Save your trained model weights}
...
identify the target while following them.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} If you need to load a model which you previously trained you can uncomment the codeline that calls the function below.}
...
it for different runs. For example, 'run\_1', 'run\_2' etc.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{n}{run\PYZus{}num} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{run\PYZus{}2}\PY{l+s+s1}{\PYZsq{}}
...
some sample images from the predictions in the validation set.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} images while following the target}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{c+c1}{\PYZsh{} images while at patrol without target}
...
discussed during the Prediction step.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{c+c1}{\PYZsh{} Scores for while the quad is following behind the target. }
...
number true positives: 539, number false positives: 0, number false negatives: 0
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}32}]:} \PY{c+c1}{\PYZsh{} Scores for images while the quad is on patrol and the target is not visable}
...
number true positives: 0, number false positives: 86, number false negatives: 0
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{c+c1}{\PYZsh{} This score measures how well the neural network can detect the target from far away}
...
number true positives: 155, number false positives: 4, number false negatives: 146
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{\PYZsh{} Sum all the true positives, etc from the three datasets to get a weight for the score}
...
0.7462365591397849
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{c+c1}{\PYZsh{} The IoU for the dataset that never includes the hero is excluded from grading}
...
0.570394116183
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{c+c1}{\PYZsh{} And the final grade score is }
